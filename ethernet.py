...
# Definitions of the socket-level I/O controol calls.
# Information source: https://github.com/torvalds/linux/blob/master/include/uapi/linux/sockios.h
_SIOCGIFHWADDR = 0x8927       # Get hardware address

# Global definitions for the Ethernet IEEE 802.3 interface.
# Information source: https://github.com/torvalds/linux/blob/master/include/uapi/linux/if_ether.h
...
ETH_P_ALL = 0x0003            # Every packet (be carefull!!!)
...
def eui48_to_bytes(s: str):
  ...
  return binascii.unhexlify(''.join(s.split(sep)))  # Return the binary data represented by 
                                                    #   the hexadecimal string hexstr
def get_hardware_address(interface):                # interface: lo, eth0, eth1 etc.
